...
#' passed belong to the same factor. However, see nitems if there is a multidimensional
...
#' 
#' @return A vector of type numeric. If nitems is given, the return is of type matrix and contains
